...
namespace Hoist.Data
{
    public static class DataUtility
    {
        ...
        //Allows DataUlity.GetPostGresDate to format our dates for our postgresql database.
        ...
        public static string GetConnectionString(IConfiguration configuration)  //Means only one - Static
        {
            //This is to get our connection string to be able to connect to our database.
        ...
        public static async Task ManageDataAsync(IServiceProvider svcProvider)
        {
            ...
            var dbContextSvc = svcProvider.GetRequiredService<ApplicationDbContext>();  //Method injection to inject the services.
            ...
            //Align the database by checking Migrations. Checks and migrates the database everytime we start the application.
        ...
        public static async Task SeedDefaultTicketsAsync(ApplicationDbContext context, UserManager<BTUser> userManager)
        {
            ...
            { 
                ...
                new Ticket()
                {
                    SubmitterUserId = company2AdminId, Title = "Blog Ticket 1",
                    Description = "Ticket details for blog ticket 1",
                    Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc),
                    ProjectId = blogId, TicketPriorityId = priorityLow,
                    TicketStatusId = statusNew,
                ...
                //BUGTRACKER                                                                                                                         
                    new Ticket() 
                    {
                        ...
                        Created = DateTime.SpecifyKind(DateTime.Now,
                        DateTimeKind.Utc), ProjectId = bugtrackerId,
                ...
                #region AddressBook Tickets
                    //ADDRESSBOOK
                    new Ticket() 
                    {
                        SubmitterUserId=company2AdminId,
                        Title = "AddressBook Ticket 1",
