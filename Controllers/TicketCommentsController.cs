...
namespace Hoist.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,BTUserId,Comment,Created")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,BTUserId,Comment,Created")] TicketComment ticketComment)
        {
