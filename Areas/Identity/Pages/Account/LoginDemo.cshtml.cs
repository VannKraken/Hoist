...
namespace Hoist.Areas.Identity.Pages.Account
{
    public class LoginDemoModel : PageModel
    {
        private readonly SignInManager<BTUser> _signInManager;
        private readonly ILogger<LoginDemoModel> _logger;
        private readonly IConfiguration _configuration;

        public LoginDemoModel(SignInManager<BTUser> signInManager, ILogger<LoginDemoModel> logger, IConfiguration config)
        {
